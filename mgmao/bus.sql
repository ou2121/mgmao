...
CREATE TABLE `gestion_bus`.`bt` (`id` INT NOT NULL AUTO_INCREMENT , `numbus` INT NOT NULL , `section` VARCHAR(255) NOT NULL ,
 `mecanicien` VARCHAR(255) NOT NULL , `datedebut` DATETIME NOT NULL , `datefin` DATETIME NOT NULL , 
 `operation` TEXT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; 
